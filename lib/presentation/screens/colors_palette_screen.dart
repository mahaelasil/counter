              ...
              children: [
                Expanded(
                  ...
                  child: DefaultMaterialButton(
                    ...
                    child: Visibility(
                      visible: cubit.backgroundColor == cubit.colors.elementAt(0),
                      child: const Icon(
                ...
                Expanded(
                  ...
                  child: DefaultMaterialButton(
                    ...
                    child: Visibility(
                      visible: cubit.backgroundColor == cubit.colors.elementAt(1),
                      child: const Icon(
                        Icons.check_circle_outline,
                        color: Colors.green,
                      ),
                ...
                Expanded(
                  ...
                  child: DefaultMaterialButton(
                    ...
                    child: Visibility(
                      visible: cubit.backgroundColor == cubit.colors.elementAt(2),
                      child: const Icon(
                        Icons.check_circle_outline,
                        color: Colors.green,
                      ),
                ...
                Expanded(
                  ...
                  child: DefaultMaterialButton(
                    ...
                    child: Visibility(
                      visible: cubit.backgroundColor == cubit.colors.elementAt(3),
                      child: const Icon(
                        Icons.check_circle_outline,
                        color: Colors.green,
                      ),
                ...
                Expanded(
                  ...
                  child: DefaultMaterialButton(
                    ...
                    child: Visibility(
                      visible: cubit.backgroundColor == cubit.colors.elementAt(4),
                      child: const Icon(
                        Icons.check_circle_outline,
                        color: Colors.green,
                      ),
